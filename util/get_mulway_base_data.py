...
# from util iqmport get_train_val_set, check_makedirs
...
for sp in [0, 1, 2, 3]:
    for mm in ['train', 'val']:
        ...
        root_path = '/ssd/wy/few-shot-seg/BAM_CLIP/BAM/data'
        ...
        # get data_list
        fss_list_root = '/ssd/wy/fss/AMNet/nips-open/AMFormer/lists/{}/fss_list/{}/'.format(args.data_set, args.mode)
